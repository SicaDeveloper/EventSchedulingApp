...
using HorizonCalender.ApiService.Controllers.Account.Dto;
...
namespace HorizonCalender.ApiService.Controllers.Account;
    ...
    IFluentEmail fluentEmail) : ApiBaseController
{
    ...
    private async Task SendChangeEmailAsync(IdentityUser<Guid> user, string newEmail)
    {
