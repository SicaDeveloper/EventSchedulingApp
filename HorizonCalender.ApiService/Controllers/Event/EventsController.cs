...
using HorizonCalender.ApiService.Controllers.Event.Dto;
...
namespace HorizonCalender.ApiService.Controllers.Event;

[Authorize]
public class EventsController(HorizonCalenderDbContext dbContext, CurrentUserService currentUserService) : ApiBaseController
{
    [HttpGet]
