...
using HorizonCalender.Data.Seeders;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Hosting;
using Microsoft.Extensions.Logging;

namespace HorizonCalender.Data.Migrator;
...
) : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        try
        {
            ...
            var dbContext = scopedServiceProvider.GetRequiredService<HorizonCalenderDbContext>();
    ...
    private static async Task SeedDataAsync(IServiceProvider serviceProvider, HorizonCalenderDbContext dbContext,
